...
//Deletes post - Executes an Ajaax POST request to the API; "".then(() => callback" - when the request is successfully completed, executes the callback function passed in, returns the user back to the homepage
